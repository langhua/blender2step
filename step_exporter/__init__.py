...
from .ui import (
    ...
    STEP_EXPORTER_OT_add_slot_to_shell,
    STEP_EXPORTER_OT_remove_shell_slot,
    STEP_EXPORTER_OT_edit_shell_slot,
    STEP_EXPORTER_OT_clear_shell_slots,
    STEP_EXPORTER_PT_shell_slots,
