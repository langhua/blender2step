...
SHELVES = [
    ...
    (_t("S2 T.Chamfer"), "chamfer", 0, [
        _make_row("Plain", None, 0, None, _t("+T.Chamfer")),
        _make_row("TBl", "top", HOLE_D, None, _t("+T.Ch+TBl")),
        _make_row("BBl", "bottom", HOLE_D, None, _t("+T.Ch+BBl")),
        _make_row("BothBl", "both", HOLE_D, None, _t("+T.Ch+Both")),
        _make_row("Thru", "through", 0, None, _t("+T.Ch+Thru")),
        _make_row("TprThru", "through", 0, 0.1, _t("+T.Ch+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+T.Ch+InvTpr")),
        _make_row("TprTBl", "top", HOLE_D, 0.08, _t("+T.Ch+TprTB")),
        _make_row("TprBBl", "bottom", HOLE_D, 0.08, _t("+T.Ch+TprBB")),
        _make_row("TprBoth", "both", HOLE_D, 0.08, _t("+T.Ch+TprBoth")),
    ...
    (_t("S3 B.Chamfer"), "bottom_chamfer", 0, [
        _make_row("Plain", None, 0, None, _t("+B.Chamfer")),
        _make_row("TBl", "top", HOLE_D, None, _t("+B.Ch+TBl")),
        _make_row("BBl", "bottom", HOLE_D, None, _t("+B.Ch+BBl")),
        _make_row("BothBl", "both", HOLE_D, None, _t("+B.Ch+Both")),
        _make_row("Thru", "through", 0, None, _t("+B.Ch+Thru")),
        _make_row("TprThru", "through", 0, 0.1, _t("+B.Ch+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+B.Ch+InvTpr")),
        _make_row("TprTBl", "top", HOLE_D, 0.08, _t("+B.Ch+TprTB")),
        _make_row("TprBBl", "bottom", HOLE_D, 0.08, _t("+B.Ch+TprBB")),
        _make_row("TprBoth", "both", HOLE_D, 0.08, _t("+B.Ch+TprBoth")),
    ...
    (_t("S4 Both Chamfer"), "chamfer_both", 0, [
        _make_row("Plain", None, 0, None, _t("+Both Cham")),
        _make_row("TBl", "top", HOLE_D, None, _t("+BothCh+TBl")),
        _make_row("BBl", "bottom", HOLE_D, None, _t("+BothCh+BBl")),
        _make_row("BothBl", "both", HOLE_D, None, _t("+BothCh+Both")),
        _make_row("Thru", "through", 0, None, _t("+BothCh+Thru")),
        _make_row("TprThru", "through", 0, 0.1, _t("+BothCh+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+BothCh+InvTpr")),
        _make_row("TprTBl", "top", HOLE_D, 0.08, _t("+BothCh+TprTB")),
        _make_row("TprBBl", "bottom", HOLE_D, 0.08, _t("+BothCh+TprBB")),
        _make_row("TprBoth", "both", HOLE_D, 0.08, _t("+BothCh+TprBoth")),
    ...
    (_t("S5 T.Fillet"), "fillet", FR_R, [
        _make_row("Plain", None, 0, None, _t("+T.Fillet")),
        _make_row("TBl", "top", HOLE_D, None, _t("+T.Fil+TBl")),
        _make_row("BBl", "bottom", HOLE_D, None, _t("+T.Fil+BBl")),
        _make_row("BothBl", "both", HOLE_D, None, _t("+T.Fil+Both")),
        _make_row("Thru", "through", 0, None, _t("+T.Fil+Thru")),
        _make_row("TprThru", "through", 0, 0.1, _t("+T.Fil+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+T.Fil+InvTpr")),
        _make_row("TprTBl", "top", HOLE_D, 0.08, _t("+T.Fil+TprTB")),
        _make_row("TprBBl", "bottom", HOLE_D, 0.08, _t("+T.Fil+TprBB")),
        _make_row("TprBoth", "both", HOLE_D, 0.08, _t("+T.Fil+TprBoth")),
    ...
    (_t("S6 B.Fillet"), "bottom_fillet", FR_R, [
        _make_row("Plain", None, 0, None, _t("+B.Fillet")),
        _make_row("TBl", "top", HOLE_D, None, _t("+B.Fil+TBl")),
        _make_row("BBl", "bottom", HOLE_D, None, _t("+B.Fil+BBl")),
        _make_row("BothBl", "both", HOLE_D, None, _t("+B.Fil+Both")),
        _make_row("Thru", "through", 0, None, _t("+B.Fil+Thru")),
        _make_row("TprThru", "through", 0, 0.1, _t("+B.Fil+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+B.Fil+InvTpr")),
        _make_row("TprTBl", "top", HOLE_D, 0.08, _t("+B.Fil+TprTB")),
        _make_row("TprBBl", "bottom", HOLE_D, 0.08, _t("+B.Fil+TprBB")),
        _make_row("TprBoth", "both", HOLE_D, 0.08, _t("+B.Fil+TprBoth")),
    ...
    (_t("S7 Both Fillet"), "fillet_both", FR_R, [
        _make_row("Plain", None, 0, None, _t("+Both Fil")),
        _make_row("TBl", "top", HOLE_D, None, _t("+BothFil+TBl")),
        _make_row("BBl", "bottom", HOLE_D, None, _t("+BothFil+BBl")),
        _make_row("BothBl", "both", HOLE_D, None, _t("+BothFil+Both")),
        _make_row("Thru", "through", 0, None, _t("+BothFil+Thru")),
        _make_row("TprThru", "through", 0, 0.1, _t("+BothFil+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+BothFil+InvTpr")),
        _make_row("TprTBl", "top", HOLE_D, 0.08, _t("+BothFil+TprTB")),
        _make_row("TprBBl", "bottom", HOLE_D, 0.08, _t("+BothFil+TprBB")),
        _make_row("TprBoth", "both", HOLE_D, 0.08, _t("+BothFil+TprBoth")),
    ...
    (_t("S8 T.Ch+B.Fil"), "chamfer_fillet", FR_R, [
        ...
        _make_row("TprThru", "through", 0, 0.1, _t("+ChFil+Tpr")),
        _make_row("InvTpr", "through_inv", 0, 0.1, _t("+ChFil+InvTpr")),
