"""
单独测试 Cylinder_Tapered_Fillet_Chamfer
"""
import bpy
import sys
import os
...
obj = bpy.data.objects.get("Cylinder_Tapered_Fillet_Chamfer")
if not obj:
...
output_path = r"F:\git\blender2step\step_exporter\test\test_tapered_fillet_chamfer.step"
