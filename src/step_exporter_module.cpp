...
PyObject* export_bottom_shell_filleted_step(PyObject* self, PyObject* args) {
    const char* filename;
    double width, depth, outer_height, bottom_thickness, wall_thickness;
    double corner_radius, outer_fillet_radius, inner_fillet_radius;
    const char* step_schema = "AP214IS";
    const char* unit = "MILLIMETER";
    int enable_logging = 1;
    ...
    if (!PyArg_ParseTuple(args, "sdddddddd|ssi",
        ...
        PyErr_SetString(PyExc_TypeError,
            ...
            "bottom_thickness, wall_thickness, corner_radius, outer_fillet_radius, inner_fillet_radius, "
            "[step_schema], [unit], [enable_logging]");
        return NULL;
    }
    ...
    try {
        TopoDS_Shape shape = create_bottom_shell_with_fillets_solid(
            width, depth, outer_height, bottom_thickness, wall_thickness,
            corner_radius, outer_fillet_radius, inner_fillet_radius);
...
PyObject* export_bottom_shell_filleted_with_holes_step(PyObject* self, PyObject* args) {
    const char* filename;
    double width, depth, outer_height, bottom_thickness, wall_thickness;
    double corner_radius, fillet_radius, hole_radius, hole_offset_x, hole_offset_y;
    const char* step_schema = "AP214IS";
    const char* unit = "MILLIMETER";
    int enable_logging = 1;

    if (!PyArg_ParseTuple(args, "sdddddddddd|ssi",
                          &filename,
                          &width, &depth, &outer_height,
                          &bottom_thickness, &wall_thickness,
                          &corner_radius, &fillet_radius,
        ...
        PyErr_SetString(PyExc_TypeError,
            ...
            "bottom_thickness, wall_thickness, corner_radius, fillet_radius, "
            "hole_radius, hole_offset_x, hole_offset_y, "
            "[step_schema], [unit], [enable_logging]");
        return NULL;
    }
    ...
    try {
        TopoDS_Shape shape = create_bottom_shell_with_fillets_and_holes(
            width, depth, outer_height, bottom_thickness, wall_thickness,
            corner_radius, fillet_radius, hole_radius, hole_offset_x, hole_offset_y);
...
static PyMethodDef step_exporter_methods[] = {
    ...
    {"export_bottom_shell_filleted_step", export_bottom_shell_filleted_step, METH_VARARGS, "Export bottom shell with filleted edges directly to STEP"},
    {"export_bottom_shell_filleted_with_holes_step", export_bottom_shell_filleted_with_holes_step, METH_VARARGS, "Export bottom shell with filleted edges and corner holes directly to STEP"},
