"""Fix the cylinder gallery operator in sample_ops.py."""
import re
...
class_start = text.index('class STEP_EXPORTER_OT_create_cylinder_gallery')
next_class = text.index('class STEP_EXPORTER_OT_create_cone_gallery')
old_class = text[class_start:next_class]

new_class = '''class STEP_EXPORTER_OT_create_cylinder_gallery(Operator):
...
print('Operator class replaced successfully')
